...
import { ProfilMenuComponent } from 'app/entities/profil-menu/profil-menu.component';
...
describe('Component Tests', () => {
    describe('ProfilMenu Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.profilMenus[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
