...
import { EvaluationcycleComponent } from 'app/entities/evaluationcycle/evaluationcycle.component';
...
describe('Component Tests', () => {
    describe('Evaluationcycle Management Component', () => {
        let comp: EvaluationcycleComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(EvaluationcycleComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.evaluationcycles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
