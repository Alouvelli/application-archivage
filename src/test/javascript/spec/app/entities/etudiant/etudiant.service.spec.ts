...
describe('Service Tests', () => {
    describe('Etudiant Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Etudiant(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', false, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Etudiant', async () => {
            ...
            it('should update a Etudiant', async () => {
                const returnedFromService = Object.assign(
                    {
                        nom: 'BBBBBB',
                        prenom: 'BBBBBB',
            ...
            it('should return a list of Etudiant', async () => {
                const returnedFromService = Object.assign(
                    {
                        nom: 'BBBBBB',
                        prenom: 'BBBBBB',
            ...
            it('should delete a Etudiant', async () => {
