...
import { TypefraisComponent } from 'app/entities/typefrais/typefrais.component';
...
describe('Component Tests', () => {
    describe('Typefrais Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.typefrais[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
