...
import { TypesalleComponent } from 'app/entities/typesalle/typesalle.component';
...
describe('Component Tests', () => {
    describe('Typesalle Management Component', () => {
        let comp: TypesalleComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TypesalleComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.typesalles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
