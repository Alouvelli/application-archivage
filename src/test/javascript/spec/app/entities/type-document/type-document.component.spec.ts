...
import { TypeDocumentComponent } from 'app/entities/type-document/type-document.component';
...
describe('Component Tests', () => {
    describe('TypeDocument Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.typeDocuments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
