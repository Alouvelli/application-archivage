...
import { AnneescolaireComponent } from 'app/entities/anneescolaire/anneescolaire.component';
...
describe('Component Tests', () => {
    describe('Anneescolaire Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.anneescolaires[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
