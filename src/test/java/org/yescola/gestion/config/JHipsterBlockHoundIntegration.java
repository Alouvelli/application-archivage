...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("service.org.yescola.gestion.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("security.org.yescola.gestion.DomainUserDetailsService", "createSpringSecurityUser");
