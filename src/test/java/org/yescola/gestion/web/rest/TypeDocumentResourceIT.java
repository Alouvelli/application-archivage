...
public class TypeDocumentResourceIT {
    ...
    public void updateTypeDocument() throws Exception {
        ...
        TypeDocument updatedTypeDocument = typeDocumentRepository.findById(typeDocument.getId())
            .orElseThrow(() -> new IllegalStateException("Type Document not found in database"));
