...
public class InscriptionResourceIT {
    ...
    public void updateInscription() throws Exception {
        ...
        Inscription updatedInscription = inscriptionRepository.findById(inscription.getId()).orElseThrow(() -> new IllegalStateException("Inscription not found in database"));
