...
public class SiteProfilResourceIT {
    ...
    public void updateSiteProfil() throws Exception {
        ...
        SiteProfil updatedSiteProfil = siteProfilRepository.findById(siteProfil.getId()).orElseThrow(() -> new IllegalStateException("SiteProfile not found in database"));;
