...
public class DocumentclasseResourceIntTest {
    ...
    public void getAllDocumentclasses() throws Exception {
        ...
        restDocumentclasseMockMvc.perform(get("/api/documentclasses?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].document1").value(hasItem(Base64Utils.encodeToString(DEFAULT_DOCUMENT_1))))
    ...
    public void getDocumentclasse() throws Exception {
        ...
        restDocumentclasseMockMvc.perform(get("/api/documentclasses/{id}", documentclasse.getId()))
            ...
            .andExpect(jsonPath("$.document1").value(Base64Utils.encodeToString(DEFAULT_DOCUMENT_1)))
    ...
    public void updateDocumentclasse() throws Exception {
        ...
        Documentclasse updatedDocumentclasse = documentclasseRepository.findById(documentclasse.getId()).get();
