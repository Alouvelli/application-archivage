...
public class ProfilModuleResourceIT {
    ...
    public void updateProfilModule() throws Exception {
        ...
        ProfilModule updatedProfilModule = profilModuleRepository.findById(profilModule.getId())
            .orElseThrow(() -> new IllegalStateException("Profil Module not found in database"));
