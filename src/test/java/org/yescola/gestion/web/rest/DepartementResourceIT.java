...
public class DepartementResourceIT {
    ...
    public void updateDepartement() throws Exception {
        ...
        Departement updatedDepartement = departementRepository.findById(departement.getId())
            .orElseThrow(() -> new IllegalStateException("Departement not found in database"));
