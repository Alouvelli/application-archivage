...
import org.yescola.gestion.service.dto.PasswordChangeDTO;
...
class AccountResourceIT {
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        User testUser = userRepository.findOneByEmailIgnoreCase("alice2@example.com")
            .orElseThrow(() -> new IllegalStateException("User alice2@example.com not found"));
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        User testUser4 = userRepository.findOneByLogin("test-register-duplicate-email-3")
            .orElseThrow(() -> new IllegalStateException("User test-register-duplicate-email-3 not found"));
        assertThat(testUser4.getEmail()).isEqualTo("test-register-duplicate-email@example.com");

        testUser4.setActivated(true);
        userService.updateUser(new UserDTO(testUser4));
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        User userDup = userRepository.findOneByLogin("badguy")
            .orElseThrow(() -> new IllegalStateException("User badguy not found"));
        assertThat(userDup.getAuthorities()).hasSize(1)
            .containsExactly(
                authorityRepository.findById(AuthoritiesConstants.USER)
                    .orElseThrow(() -> new IllegalStateException("Authority USER not found"))
            );
    }
