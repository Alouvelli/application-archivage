...
public class ClasseResourceIntTest {
    ...
    public void setup() {
        ...
        final ClasseResource classeResource = new ClasseResource(classeRepository,niveauRepository);
    ...
    public void createClasse() throws Exception {
        ...
        assertThat(testClasse.isEtat()).isEqualTo(DEFAULT_ETAT);
    ...
    public void updateClasse() throws Exception {
        ...
        assertThat(testClasse.isEtat()).isEqualTo(UPDATED_ETAT);
