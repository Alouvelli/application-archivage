...
public class RubriqueProfilResourceIT {
    ...
    public void updateRubriqueProfil() throws Exception {
        ...
        RubriqueProfil updatedRubriqueProfil = rubriqueProfilRepository.findById(rubriqueProfil.getId())
            .orElseThrow(() -> new IllegalStateException("Rubrique Profile not found in database"));
