...
@NgModule({
    imports: [
        ...
        GestionEcoleSharedModule.forRoot(),
    ...
    declarations: [ HomeComponent, JhiMainComponent, NavbarComponent, ErrorComponent, PageRibbonComponent, ActiveMenuDirective, FooterComponent],
    providers: [
        {
