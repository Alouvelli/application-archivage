...
export class DocumentexcelUpdateComponent implements OnInit {
    ...
    save() {
        this.isSaving = true;
        if (this.documentexcel.id !== undefined) {
            this.subscribeToSaveResponse(this.documentexcelService.update(this.documentexcel));
        } else {
            this.subscribeToSaveResponse(this.documentexcelService.create(this.documentexcel));
        }
    }

    protected subscribeToSaveResponse(result: Observable<HttpResponse<IDocumentexcel>>) {
        result.subscribe((res: HttpResponse<IDocumentexcel>) => this.onSaveSuccess(), (res: HttpErrorResponse) => this.onSaveError());
    }
