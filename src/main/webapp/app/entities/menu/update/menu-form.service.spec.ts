      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            codeMenu: expect.any(Object),
            libelleMenu: expect.any(Object),
            rangMenu: expect.any(Object),
            urlMenu: expect.any(Object),
            iconeMenu: expect.any(Object),
            etatMenu: expect.any(Object),
