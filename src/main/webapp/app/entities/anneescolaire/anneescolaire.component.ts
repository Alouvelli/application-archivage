...
export class AnneescolaireComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.anneescolaireService
            ...
            .subscribe(
                (res: HttpResponse<IAnneescolaire[]>) => this.paginateAnneescolaires(res.body, res.headers),
    ...
    trackId(index: number, item: IAnneescolaire) {
        return item.id;
    }

    registerChangeInAnneescolaires() {
        this.eventSubscriber = this.eventManager.subscribe('anneescolaireListModification', response => this.loadAll());
    }
    ...
    protected paginateAnneescolaires(data: IAnneescolaire[], headers: HttpHeaders) {
