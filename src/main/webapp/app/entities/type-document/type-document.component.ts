...
export class TypeDocumentComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.typeDocumentService
            ...
            .subscribe(
                (res: HttpResponse<ITypeDocument[]>) => this.paginateTypeDocuments(res.body, res.headers),
    ...
    registerChangeInTypeDocuments() {
        this.eventSubscriber = this.eventManager.subscribe('typeDocumentListModification', response => this.loadAll());
    }
