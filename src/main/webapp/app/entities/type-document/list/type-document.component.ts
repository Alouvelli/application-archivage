...
export class TypeDocumentComponent implements OnInit {
  ...
  typeDocuments = signal<ITypeDocument[]>([]);
  isLoading = false;
  ...
  protected readonly typeDocumentService = inject(TypeDocumentService);
  protected readonly activatedRoute = inject(ActivatedRoute);
  protected readonly sortService = inject(SortService);
  protected modalService = inject(NgbModal);
  protected ngZone = inject(NgZone);

  trackId = (item: ITypeDocument): number => this.typeDocumentService.getTypeDocumentIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.typeDocuments.set(dataFromBody);
  }
