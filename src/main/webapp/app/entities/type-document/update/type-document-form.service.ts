...
type TypeDocumentFormDefaults = Pick<NewTypeDocument, 'id' | 'etat'>;
...
type TypeDocumentFormGroupContent = {
  ...
  description: FormControl<ITypeDocument['description']>;
  etat: FormControl<ITypeDocument['etat']>;
};
...
export class TypeDocumentFormService {
  createTypeDocumentFormGroup(typeDocument: TypeDocumentFormGroupInput = { id: null }): TypeDocumentFormGroup {
    ...
    return new FormGroup<TypeDocumentFormGroupContent>({
      ...
      description: new FormControl(typeDocumentRawValue.description),
      etat: new FormControl(typeDocumentRawValue.etat),
    });
  }
