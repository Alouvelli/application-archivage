...
@Component({
    selector: 'jhi-documentclasse-update2',
    templateUrl: './documentclasse-update2.component.html'
})
export class DocumentclasseUpdate2Component implements OnInit {
    semestres: ISemestre[];
    ...
    save() {
        ...
        if (this.documentclasse.id !== undefined) {
            ...
            this.documentclasse.classe=this.classes.filter((a)=>a.libelle==this.motclasse)[0];
