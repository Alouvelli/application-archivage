...
export class DocumentclasseComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    constructor(
        ...
        protected anneeService:AnneescolaireService,
    ...
    ngOnInit() {
        ...
        this.motsemestre=="";
        //this.loadAll();
        this.documentclasseService.getAllDc().subscribe(
            (data)=>{
                console.log(data.body);
                console.log("mouhamed");
                this.documentclasses=data.body;
            }
        );
        ...
        jQuery(document).ready(setTimeout(function() {
            ...
            $('#dane2').on('change',function () {
                ...
                if(!$.all2){
                    ...
                    comp.motsemestre=$.all2;
                    console.log(comp.motsemestre);
