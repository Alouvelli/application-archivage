...
import { sampleWithRequiredData } from '../semestre.test-samples';
...
describe('Semestre Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.semestres()[0]).toEqual(expect.objectContaining({ id: 22194 }));
  });

  describe('trackId', () => {
    it('should forward to semestreService', () => {
      const entity = { id: 22194 };
      jest.spyOn(service, 'getSemestreIdentifier');
      const id = comp.trackId(entity);
      expect(service.getSemestreIdentifier).toHaveBeenCalledWith(entity);
