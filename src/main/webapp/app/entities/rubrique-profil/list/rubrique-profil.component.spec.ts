...
import { sampleWithRequiredData } from '../rubrique-profil.test-samples';
...
describe('RubriqueProfil Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RubriqueProfilComponent],
      providers: [
        provideHttpClient(),
        {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.rubriqueProfils()[0]).toEqual(expect.objectContaining({ id: 1884 }));
  });

  describe('trackId', () => {
    it('should forward to rubriqueProfilService', () => {
      const entity = { id: 1884 };
      jest.spyOn(service, 'getRubriqueProfilIdentifier');
      const id = comp.trackId(entity);
      expect(service.getRubriqueProfilIdentifier).toHaveBeenCalledWith(entity);
