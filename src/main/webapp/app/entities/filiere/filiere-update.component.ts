...
export class FiliereUpdateComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.departementService
            ...
            .subscribe((res: IDepartement[]) => {this.departements = res;
                for(let x of this.departements){

                    if(this.filiere.departement.id) {
                        if (this.filiere.departement.id == x.id) {
                            x.cocher = true;
                        }
                    }
    ...
    save() {
        ...
        if (this.filiere.id !== undefined) {
            if($.all){
                ...
                this.filiere.departement=this.departements.filter((a)=>(a.cocher==true))[0];
            }
