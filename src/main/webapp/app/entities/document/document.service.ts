...
export class DocumentService {
    ...
    public resourcedocument = SERVER_API_URL + 'api/maxDocument';
    ...
    maxDocument(id: number): Observable<any> {
        return this.http.get<any>(`${this.resourcedocument}/${id}`, { observe: 'response' });
    }
