...
import { EcoleService, EntityArrayResponseType } from '../service/ecole.service';
...
export class EcoleComponent implements OnInit {
  ...
  protected readonly ecoleService = inject(EcoleService);
  protected readonly activatedRoute = inject(ActivatedRoute);
  protected readonly sortService = inject(SortService);
  protected modalService = inject(NgbModal);
  protected ngZone = inject(NgZone);

  trackId = (item: IEcole): number => this.ecoleService.getEcoleIdentifier(item);
