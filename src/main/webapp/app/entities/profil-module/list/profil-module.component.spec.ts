...
import { sampleWithRequiredData } from '../profil-module.test-samples';
...
describe('ProfilModule Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.profilModules()[0]).toEqual(expect.objectContaining({ id: 26655 }));
  });

  describe('trackId', () => {
    it('should forward to profilModuleService', () => {
      const entity = { id: 26655 };
      jest.spyOn(service, 'getProfilModuleIdentifier');
      const id = comp.trackId(entity);
      expect(service.getProfilModuleIdentifier).toHaveBeenCalledWith(entity);
