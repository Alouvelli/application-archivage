...
import {anneeScolaire} from "../../app.constants";

@Component({
    selector: 'jhi-inscriptionClasse',
    templateUrl: './inscriptionClasse.component.html'
})
export class InscriptionClasseComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    ngOnInit() {
        ...
        jQuery(document).ready(setTimeout(function() {
            ...
            $('#dane2').on('change',function () {
                ...
                if(!$.all2){
                    comp.motanneScolaire="";

                }else {
                    comp.motanneScolaire=$.all2;
    ...
    protected paginateInscriptions(data: IInscription[], headers: HttpHeaders) {
        ...
        this.inscriptions = data;/*.filter((a)=>a.anneescolaire.libelle==anneeScolaire);*/
    }
