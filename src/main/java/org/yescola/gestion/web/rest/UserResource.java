...
public class UserResource {
    ...
    public List<Employe> getEmploye(@PathVariable Long id) {
        return userRepository.getEmploye(id);
    }

    @GetMapping("/getEmployeByLogin/{id}")
    public List<Employe> getEmployeByLogin(@PathVariable String id) {
        return userRepository.getEmployeByLogin(id);
    }

    @GetMapping("/getAllProfil")
    public List<Profil> getAllProfil() {
        return userRepository.findAllProfil();
    }

    @GetMapping("/getsiteProfilX/{id}")
    public List<SiteProfil> getsiteProfilX(@PathVariable  Long id) {
        return userRepository.getsiteProfilX(id);
    }
    @GetMapping("/getProfilModuleX/{id}")
    public List<ProfilModule> getProfilModuleX(@PathVariable  Long id) {
        return userRepository.getProfilModuleX(id);
    }
    @GetMapping("/getProfilRubriqueX/{id}")
    public List<RubriqueProfil> getProfilRubriqueX(@PathVariable  Long id) {
        return userRepository.getProfilRubriqueX(id);
    }
    @GetMapping("/getProfilMenuX/{id}")
