...
export class RubriqueComponent implements OnInit, OnDestroy {
        ...
        this.rubriqueService
            ...
            .subscribe(
                (res: HttpResponse<IRubrique[]>) =>{ this.paginateRubriques(res.body, res.headers)
                    for(let sit of this.rubriques) {
                        this.relierRubriqueMenu(sit);
                    }
                },
    ...
    relierRubriqueMenu(sit){
        this.rubriqueService.getMenu(sit.id).subscribe(
            (data)=>{
    ...
    setActive(rubrique,etat){

        if(etat==0){
            rubrique.etatRubrique=1
        }else {
            rubrique.etatRubrique=0
        }
