...
export class ModuleService {
    ...
    public resourcegetRubriques = SERVER_API_URL + 'api/getRubriques';
    ...
    getRubrique(id: number): Observable<any> {
        return this.http.get<any>(`${this.resourcegetRubriques}/${id}`, { observe: 'response' });
    }
}
